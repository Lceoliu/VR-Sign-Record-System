...
namespace SignVR.Interaction.CaptureHost
{
    ...
    public sealed class InteractionObjectStateProbe : MonoBehaviour
    {
        ...
        public void Configure(string id, Transform value = null)
        {
            ...
            {
                throw new ArgumentException("Object ID is required.", nameof(id));
            }
            objectId = id.Trim();
        ...
        public string CaptureStateJson()
        {
            ...
            builder.Append('{');
            InteractionRunManifestContractV1.AppendName(builder, "active_in_hierarchy");
            ...
            InteractionRunManifestContractV1.AppendSeparatorAndName(builder, "logical_state");
            InteractionJson.AppendQuoted(builder, logicalState ?? string.Empty);
            builder.Append('}');
